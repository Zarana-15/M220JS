...
export default class MoviesDAO {
  ...
  static async facetedSearch({
    ...
    */
    ...
    // queryPipeline.append(limitStage)
    // queryPipeline.append(skipStage)
    // queryPipeline.append(facetStage)
  ...
  static async getMovieByID(id) {
    try {
      ...
      */
      ...
      const MONGODB_ERROR_MESSAGE =
        "Error"

      const objectIdError = e.toString().startsWith(MONGODB_ERROR_MESSAGE)

      if (objectIdError) return null
    }
  }
}
